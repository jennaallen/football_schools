...
Before I can load the fact tables, I need to create the dimDate and dimSchoolYear tables.

```{r}
create_date_table <- function () {
  date_value <- seq(as.Date("01/01/2011",format ="%m/%d/%Y"), by = "day", length.out = 6940)
