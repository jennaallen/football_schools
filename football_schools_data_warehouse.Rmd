...
clean_football_data <- function(original_football_data) {
  ...
  # dataframe has two columns with "Pts" name so one needs to be renamed
  ...
  football_data_transform <- football_data_transform[!(football_data_transform$Rk %in% "Rk") & !(football_data_transform$Notes %in% "Game Cancelled"), ] 
...
fuzzy_text_match_final <- rbindlist(list(fuzzy_text_match_final, text_matches_for_review[text_matches_for_review$correct_match == 1, c("football_schools", "schools")]))
```
...
fuzzy_text_match_final <- rbindlist(list(fuzzy_text_match_final, fuzzy_text_results_conc_before_review[fuzzy_text_results_conc_before_review$correct_match == 1, c("football_schools", "schools")]))
```
...
dbWriteTable(con, name = "dimSchool", 
             value = school_data_transform[school_data_transform$school_year_start == 
                                             max(school_data_transform$school_year_start) & school_data_transform$school_name %in% fuzzy_text_match_final$schools, 
                                                        c("school_id",
                                                          "school_name",
                                                          "school_alias",
                                                          "school_city",
