...
An R Notebook was used to annotate my code. Please view/download the [tidy_football_schools_dw.md](https://github.com/jallen1006/football_schools/blob/master/tidy_football_schools_dw.md) file for a comprehensive walk-through of this project. 
