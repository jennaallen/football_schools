...
clean_football_data <- function(original_football_data) {
  football_data_transform <- original_football_data #create a copy of the staging data for transformations
...
football_data_transform <- clean_football_data(football_data_staging)
